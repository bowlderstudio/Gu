...
public class Utils {
	...
	public static Connection connectLocal(Properties p) {
		try {
			...
			s.execute("CREATE TABLE IF NOT EXISTS stocks (code VARCHAR(20),name VARCHAR(100),industrySector VARCHAR(50),industrySubSector VARCHAR(50),changeRate REAL,closePrice REAL,increastRate REAL,"
